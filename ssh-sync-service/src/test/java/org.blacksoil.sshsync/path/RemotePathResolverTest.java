package org.blacksoil.sshsync.path;

import org.blacksoil.sshsync.domain.RemotePathResolver;
...
class RemotePathResolverTest {
    ...
    @Test void blank_defaults_to_home() {
