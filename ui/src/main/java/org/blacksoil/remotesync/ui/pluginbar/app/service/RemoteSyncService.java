package org.blacksoil.remotesync.ui.pluginbar.app.service;
...
import org.blacksoil.remotesync.ui.pluginbar.app.client.SshSyncClient;
...
public class RemoteSyncService {
  ...
  private final String GIT_DIFF_BASE_URL = "http://127.0.0.1:8081";
  private final String SSH_SYNC_BASE_URL = "http://127.0.0.2:8082";
