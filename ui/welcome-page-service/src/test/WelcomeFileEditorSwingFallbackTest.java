...
class WelcomeFileEditorSwingFallbackTest {
  ...
  void usesSwingFallbackWhenJcefUnsupported() {
    ...
    when(loader.loadOrNull("src/main/resources/welcome.html")).thenReturn(null);
    when(loader.loadOrNull("src/main/resources/fallback.html"))
        .thenReturn("<html>v=${version}</html>");
