...
class WelcomeFileEditorJcefTest {
  ...
  void createsJcefBrowserAndLoadsHtml() {
    ...
    when(loader.loadOrNull("src/main/resources/welcome.html"))
        .thenReturn("<html>${version}</html>");
    when(loader.loadOrNull("src/main/resources/fallback.html")).thenReturn(null);
