package org.blacksoil.remotesync.ui.welcome.ui;

import static org.blacksoil.remotesync.ui.welcome.constant.WelcomeConstants.FALLBACK_HTML_PATH;
import static org.blacksoil.remotesync.ui.welcome.constant.WelcomeConstants.PRIMARY_HTML_PATH;
...
import org.blacksoil.remotesync.ui.welcome.api.HtmlLoader;
...
import org.blacksoil.remotesync.ui.welcome.impl.browser.DefaultBrowserProvider;
import org.blacksoil.remotesync.ui.welcome.impl.resource.ClasspathHtmlLoader;
import org.blacksoil.remotesync.ui.welcome.impl.version.IntellijPluginVersionProvider;
...
public final class WelcomeFileEditor extends UserDataHolderBase implements FileEditor {
  ...
  public WelcomeFileEditor(
    ...
    String html =
        WelcomeConstants.applyVersion(
            WelcomeConstants.pickHtmlOrDefault(primary, fallback), version);
