...
public class SshUploader {
    ...
    public static void uploadFiles(List<String> files, String localRoot, String remotePath,
    ...
    private static void uploadFile(Session session, File localFile, String remoteFilePath) throws Exception {
